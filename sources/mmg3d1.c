    ...
    for (k=1; k<=mesh->ne; k++) {
      ...
      for (i=0; i<4; i++) {
        ...
        for (j=0; j<3; j++) {
          ...
          ddb = ((pt->v[iare[ia][0]] == 12849) && (pt->v[iare[ia][1]] == 12850)) || ((pt->v[iare[ia][1]] == 12849) && (pt->v[iare[ia][0]] == 12850));
          if( ddb ) printf("On est dans la face : %d %d %d ---> tag = %d\n",pt->v[idir[i][0]],pt->v[idir[i][1]],pt->v[idir[i][2]],pxt->ftag[i]); 
