...
ADD_TEST(NAME mmg3d_SimpleCube2
...
ADD_TEST(NAME mmg3d_CubeIso_h_hminMax2
...
ADD_TEST(NAME mmg3d_CubeIso_0.5h_hminMax2
  COMMAND ${EXECUT_MMG3D}
...
ADD_TEST(NAME mmg3d_CubeIso_0.25h_hminMax2
  COMMAND ${EXECUT_MMG3D}
...
ADD_TEST(NAME mmg3d_SphereIso_0.25h_met2
  COMMAND ${EXECUT_MMG3D}
...
ADD_TEST(NAME mmg3d_SphereIso_0.125h_met2
  COMMAND ${EXECUT_MMG3D}
...
ADD_TEST(NAME mmg3d_SphereIso_2smallh_met2
  COMMAND ${EXECUT_MMG3D}
...
ADD_TEST(NAME mmg3d_SphereIso_4smallh_met2
  COMMAND ${EXECUT_MMG3D}
...
ADD_TEST(NAME mmg3d_SphereIso_8smallh_met2
  COMMAND ${EXECUT_MMG3D}
...
ADD_TEST(NAME mmg3d_SphereIso_h_hausd0.001_2
  COMMAND ${EXECUT_MMG3D}
...
ADD_TEST(NAME mmg3d_SphereIso_h_hausd0.005_2
  COMMAND ${EXECUT_MMG3D}
...
ADD_TEST(NAME mmg3d_CubeSkin0.0125_Inside0.25_2
  COMMAND ${EXECUT_MMG3D}
...
ADD_TEST(NAME mmg3d_CubeSkin0.0125_Inside0.5_2
  COMMAND ${EXECUT_MMG3D}
...
ADD_TEST(NAME mmg3d_Various_unref_Linkrods_met0.2_2
  COMMAND ${EXECUT_MMG3D}
...
ADD_TEST(NAME mmg3d_Various_unref_Linkrods_met0.2_hausd0.01_2
  COMMAND ${EXECUT_MMG3D}
...
ADD_TEST(NAME mmg3d_Various_ref_Linkrods_met0.05_2
  COMMAND ${EXECUT_MMG3D}
...
ADD_TEST(NAME mmg3d_Various_ref_Linkrods_met0.05_hausd0.01_2
  COMMAND ${EXECUT_MMG3D}
...
ADD_TEST(NAME mmg3d_Various_ref_Linkrods_met0.05_hausd0.001_2
  COMMAND ${EXECUT_MMG3D}
...
ADD_TEST(NAME mmg3d_Various_refunref_Santa_met0.05_hausd0.001_ar90_2
  COMMAND ${EXECUT_MMG3D}
...
ADD_TEST(NAME mmg3d_Various_refunref_Santa_met0.05_hausd0.0001_ar90_2
  COMMAND ${EXECUT_MMG3D}
...
IF ( PATTERN )
  ADD_TEST(NAME mmg3d_Various_adpsol_hgrad1_M6Mach_Eps0.001_hmin0.001_hmax2_2
    COMMAND ${EXECUT_MMG3D}
  ...
  ADD_TEST(NAME mmg3d_Various_adpsol_hgrad1_M6Mach_Eps0.0005_hmin0.0001_hmax3_2
    COMMAND ${EXECUT_MMG3D}
...
SET_TESTS_PROPERTIES(mmg3d_TorusholesAni_${EXECUT_MMG3D}_2 PROPERTIES
  DEPENDS mmg3d_TorusholesAni_${EXECUT_MMG3D})

ADD_TEST(NAME mmg3d_TorusholesAni_chocCyl_${EXECUT_MMG3D}_2
 COMMAND ${EXECUT_MMG3D} -v 5 -hgrad 1.15
 ${MMG_CI_TESTS}/TorusholesAni_chocCyl/torusholesTiny.o.meshb
 -out ${MMG_CI_TESTS}/TorusholesAni_chocCyl/torusholesTiny.o.o.meshb)

SET_TESTS_PROPERTIES(mmg3d_TorusholesAni_chocCyl_${EXECUT_MMG3D}_2 PROPERTIES
  DEPENDS mmg3d_TorusholesAni_chocCyl_${EXECUT_MMG3D})
