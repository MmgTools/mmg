...
FOREACH(EXEC ${LISTEXEC_MMG})
 ...
 ADD_TEST(NAME mmg_TorusholesAni_chocCyl_${EXEC}
  ...
  ##############################################################################
  #####
  ADD_TEST(NAME mmg_LeakCheck_AbnormalEnd2_${EXEC}
    COMMAND ${EXEC} -v 5
    ${MMG_CI_TESTS}/LeakCheck_AbnormalEnd2/d)
  SET(passRegex "## Unable to scale mesh.")
  SET_PROPERTY(TEST mmg_LeakCheck_AbnormalEnd2_${EXEC}
    PROPERTY PASS_REGULAR_EXPRESSION "${passRegex}")
  #####
  ADD_TEST(NAME mmg_LeakCheck_AbnormalEnd7_${EXEC}
    COMMAND ${EXEC} -v 5
  ...
  SET_PROPERTY(TEST mmg_LeakCheck_AbnormalEnd7_${EXEC}
    PROPERTY PASS_REGULAR_EXPRESSION "${passRegex}")
  #####
  ADD_TEST(NAME mmg_LeakCheck_AbnormalEnd8_${EXEC}
    COMMAND ${EXEC} -v 5
  ...
  SET_PROPERTY(TEST mmg_LeakCheck_AbnormalEnd8_${EXEC}
    PROPERTY PASS_REGULAR_EXPRESSION "${passRegex}")
  #####
  #####
  ADD_TEST(NAME mmg_LeakCheck_args0_${EXEC}
    COMMAND ${EXEC} -v 5
    ${MMG_CI_TESTS}/LeakCheck_args0/d)
  #####
  ADD_TEST(NAME mmg_LeakCheck_args1_${EXEC}
    COMMAND ${EXEC} -v 5
  ...
  ##############################################################################
  #####
  ADD_TEST(NAME mmg_HausdLoc_2Spheres${EXEC}
  ...
  #####
  ADD_TEST(NAME mmg_hminmaxLoc_2Spheres${EXEC}
    COMMAND ${EXEC} -v 5 -hgrad 2
    ${MMG_CI_TESTS}/HausdLoc_2Spheres/2spheres
    ${MMG_CI_TESTS}/HausdLoc_2Spheres/2spheres.o.meshb
    -hgrad 2
  ...
  ##############################################################################
  #####
  ADD_TEST(NAME mmg_MeshVersionFormatted1_${EXEC}
    COMMAND ${EXEC} -v 5
    -in ${MMG_CI_TESTS}/MeshVersionFormatted1/d
    -sol ${MMG_CI_TESTS}/MeshVersionFormatted1/dsol.sol)
  #####
  ADD_TEST(NAME mmg_MeshVersionFormatted2_${EXEC}
    COMMAND ${EXEC} -v 5
