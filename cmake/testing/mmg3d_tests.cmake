...
IF ( LONG_TESTS )
  ...
  ADD_TEST(NAME MultiDom_Cube
    COMMAND ${EXECUT_MMG3D} -hmax 0.02 ${MMG3D_CI_TESTS}/MultiDom_Cube/c
    -out ${MMG3D_CI_TESTS}/MultiDom_Cube/c.o.meshb)

  ADD_TEST(NAME MultiDom_Ellipse
    COMMAND ${EXECUT_MMG3D} -hausd 0.0003 ${MMG3D_CI_TESTS}/MultiDom_Ellipse/c.d
