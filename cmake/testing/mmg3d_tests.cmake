...
ADD_TEST(NAME mmg3d_SimpleCube
...
FOREACH(EXEC ${LISTEXEC_MMG3D})
  ...
  ##############################################################################
  #####
  ADD_TEST(NAME mmg3d_LeakCheck_AbnormalEnd3_${EXEC}
    COMMAND ${EXEC} -v 5
  ...
  SET_PROPERTY(TEST mmg3d_LeakCheck_AbnormalEnd3_${EXEC}
    PROPERTY PASS_REGULAR_EXPRESSION "${passRegex}")
  #####
  ADD_TEST(NAME mmg3d_LeakCheck_optLevelSet_${EXEC}
  ...
  ADD_TEST(NAME mmg3d_ChkBdry_optls_temp_${EXEC}
    ...
    -out temp.o.meshb)
  ####
  ADD_TEST(NAME mmg3d_ChkBdry_optls_temp2_${EXEC}
    COMMAND ${EXEC} -v 5  -ls -hmin 5 -hmax 6
    -nr -hausd 0.5 -hgrad 1.2
    -in ${MMG3D_CI_TESTS}/ChkBdry_optls_temp/temp
    -sol ${MMG3D_CI_TESTS}/ChkBdry_optls_temp/temp.sol
    -out temp.o.meshb)
  #####
  ADD_TEST(NAME mmg3d_ChkBdry_cube_${EXEC}
    COMMAND ${EXEC} -v 5
    ${MMG3D_CI_TESTS}/ChkBdry_cube/cube)
  #####
  ADD_TEST(NAME mmg3d_ChkBdry_multidomCube_${EXEC}
    COMMAND ${EXEC} -v 5 -hmax 0.1
    ${MMG3D_CI_TESTS}/ChkBdry_multidomCube/c)
  #####
  ADD_TEST(NAME mmg3d_ChkBdry_multidomCube2_${EXEC}
    COMMAND ${EXEC} -v 5 -hmax 0.1
    ${MMG3D_CI_TESTS}/ChkBdry_multidomCube2/c)
  #####
  ADD_TEST(NAME mmg3d_ChkBdry_multidomCube3_${EXEC}
    COMMAND ${EXEC} -v 5 -hmax 0.1
  ...
  ##############################################################################
  #####
  ADD_TEST(NAME mmg3d_TetLoc_Ellipse${EXEC}
...
IF ( LONG_TESTS )
  ...
  ADD_TEST(NAME mmg3d_SphereIso_2smallh_met
    COMMAND ${EXECUT_MMG3D} -v 5
    ${MMG3D_CI_TESTS}/SphereIso_2smallh_met/SphereIso0.0625 -hausd 0.1
    -out SphereIso0.0625.o.meshb)
  ADD_TEST(NAME mmg3d_SphereIso_4smallh_met
    COMMAND ${EXECUT_MMG3D} -v 5
    ${MMG3D_CI_TESTS}/SphereIso_4smallh_met/SphereIso0.0625 -hausd 0.1
    -out SphereIso0.0625.o.meshb)
  ADD_TEST(NAME mmg3d_SphereIso_8smallh_met
    COMMAND ${EXECUT_MMG3D} -v 5
  ...
  ADD_TEST(NAME mmg3d_SphereIso_h_hausd0.001
    COMMAND ${EXECUT_MMG3D} -v 5
    ${MMG3D_CI_TESTS}/SphereIso_h_hausd0.001/SphereIso0.5 -hausd 0.001 -hgrad 500
    -out SphereIso0.5.o.meshb)
  ADD_TEST(NAME mmg3d_SphereIso_h_hausd0.005
    COMMAND ${EXECUT_MMG3D} -v 5
  ...
  ADD_TEST(NAME mmg3d_CubeSkin0.05_Inside0.4
    COMMAND ${EXECUT_MMG3D} -v 5
    ${MMG3D_CI_TESTS}/CubeSkin0.05_Inside0.4/CubeSkin0.05
    CubeSkin0.05.o.meshb)
  ADD_TEST(NAME mmg3d_CubeSkin0.1_Inside0.4
    COMMAND ${EXECUT_MMG3D} -v 5
    ${MMG3D_CI_TESTS}/CubeSkin0.1_Inside0.4/CubeSkin0.1
    CubeSkin0.1.o.meshb)
  ADD_TEST(NAME mmg3d_CubeSkin0.2_Inside0.4
    COMMAND ${EXECUT_MMG3D} -v 5
    ${MMG3D_CI_TESTS}/CubeSkin0.2_Inside0.4/CubeSkin0.2
    CubeSkin0.2.o.meshb)
  ADD_TEST(NAME mmg3d_CubeSkin0.0125_Inside0.125
    COMMAND ${EXECUT_MMG3D} -v 5
    ${MMG3D_CI_TESTS}/CubeSkin0.0125_Inside0.125/CubeSkin0.125
    -out CubeSkin0.125.o.meshb)
  ADD_TEST(NAME mmg3d_CubeSkin0.0125_Inside0.25
    COMMAND ${EXECUT_MMG3D} -v 5
    ${MMG3D_CI_TESTS}/CubeSkin0.0125_Inside0.25/CubeSkin0.25
    -out CubeSkin0.25.o.meshb)
  ADD_TEST(NAME mmg3d_CubeSkin0.0125_Inside0.5
    COMMAND ${EXECUT_MMG3D} -v 5
  ...
  ADD_TEST(NAME mmg3d_Various_unref_Linkrods_met0.2
    COMMAND ${EXECUT_MMG3D} -v 5
    ${MMG3D_CI_TESTS}/Various_unref_Linkrods_met0.2/linkrods -hausd 0.1
    linkrods.o.meshb)
  ADD_TEST(NAME mmg3d_Various_unref_Linkrods_met0.2_hausd0.01
    COMMAND ${EXECUT_MMG3D} -v 5
  ...
  ADD_TEST(NAME mmg3d_Various_ref_Linkrods_met0.05
    COMMAND ${EXECUT_MMG3D} -v 5
    ${MMG3D_CI_TESTS}/Various_ref_Linkrods_met0.05/linkrods -hausd 0.1
    linkrods.o.meshb)
  ADD_TEST(NAME mmg3d_Various_ref_Linkrods_met0.05_hausd0.01
    COMMAND ${EXECUT_MMG3D} -v 5
    ${MMG3D_CI_TESTS}/Various_ref_Linkrods_met0.05_hausd0.01/linkrods
    -hausd 0.01
    linkrods.o.meshb)
  ADD_TEST(NAME mmg3d_Various_ref_Linkrods_met0.05_hausd0.001
    COMMAND ${EXECUT_MMG3D} -v 5
  ...
  ADD_TEST(NAME mmg3d_Various_refunref_Santa_met0.05_hausd0.001_ar90
    COMMAND ${EXECUT_MMG3D} -v 5
    ${MMG3D_CI_TESTS}/Various_refunref_Santa_met0.05_hausd0.001_ar90/santa
    -hausd 0.001 -ar 90
    santa.o.meshb)
  ADD_TEST(NAME mmg3d_Various_refunref_Santa_met0.05_hausd0.0001_ar90
    COMMAND ${EXECUT_MMG3D} -v 5
  ...
  IF ( PATTERN )
    ADD_TEST(NAME mmg3d_Various_adpsol_hgrad1_M6Mach_Eps0.001_hmin0.001_hmax2
      COMMAND ${EXECUT_MMG3D} -v 5
      ...
      -hausd 0.1 -ar 60
      M6.o.meshb)
    ADD_TEST(NAME mmg3d_Various_adpsol_hgrad1_M6Mach_Eps0.0005_hmin0.0001_hmax3
      COMMAND ${EXECUT_MMG3D} -v 5
  ...
  #####
  IF ( USE_SUSCELAS )
    ADD_TEST(NAME mmg3d_LagMotion1_boxt_${EXEC}
      COMMAND ${EXEC} -v 5  -lag 1
