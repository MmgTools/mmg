...
IF (MMG_PYTHON_API)
  IF (NOT LIBMMG_SHARED)
    MESSAGE ("WARNING: SHARED LIBRARIES MUST BE ACTIVATED TO CREATE PYTHON API (OPTION BUILD_SHARED_LIBS).")
  ELSE()
    SET(ENV{HEADER3D_FILE} ${MMG3D_INCLUDE}/libmmg3d.h)
    SET(ENV{HEADER2D_FILE} ${MMG2D_INCLUDE}/libmmg2d.h)
    SET(ENV{HEADERS_FILE}  ${MMGS_INCLUDE}/libmmgs.h)
    IF (APPLE)
    ...
    ENDIF()
    SET(ENV{SHARED_LIB_FILE2D} ${PROJECT_BINARY_DIR}/lib/libmmg2d${LIB_EXTENSION})
