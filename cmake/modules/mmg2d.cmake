...
IF ( BUILD_TESTING )
  ...
  IF ( MMG2D_CI )
    ...
    IF ( TEST_LIBMMG2D )
      ...
      SET(LIBMMG2D_LSANDMETRIC_OPTIM ${EXECUTABLE_OUTPUT_PATH}/libmmg2d_lsAndMetric_optim )
      SET(LIBMMG2D_LSANDMETRIC_HSIZ ${EXECUTABLE_OUTPUT_PATH}/libmmg2d_lsAndMetric_hsiz )
      ...
      ADD_TEST(NAME libmmg2d_lsAndMetric_optim   COMMAND ${LIBMMG2D_LSANDMETRIC_OPTIM}
        "${PROJECT_SOURCE_DIR}/libexamples/mmg2d/IsosurfDiscretization_lsOnly/multi-mat.mesh"
        "${PROJECT_SOURCE_DIR}/libexamples/mmg2d/IsosurfDiscretization_lsOnly/multi-mat-sol.sol"
        "${CTEST_OUTPUT_DIR}/libmmg2d_lsAndMetric_optim_multimat.o"
        )
      ...
      ADD_TEST(NAME libmmg2d_lsAndMetric_hsiz   COMMAND ${LIBMMG2D_LSANDMETRIC_HSIZ}
        "${PROJECT_SOURCE_DIR}/libexamples/mmg2d/IsosurfDiscretization_lsOnly/multi-mat.mesh"
        "${PROJECT_SOURCE_DIR}/libexamples/mmg2d/IsosurfDiscretization_lsOnly/multi-mat-sol.sol"
        "${CTEST_OUTPUT_DIR}/libmmg2d_lsAndMetric_hsiz_multimat.o"
        )
      ...
      IF ( CMAKE_Fortran_COMPILER)
        ...
        SET(LIBMMG2D_EXECFORTRAN_LSANDMETRIC_OPTIM ${EXECUTABLE_OUTPUT_PATH}/libmmg2d_fortran_lsAndMetric_optim )
        SET(LIBMMG2D_EXECFORTRAN_LSANDMETRIC_HSIZ ${EXECUTABLE_OUTPUT_PATH}/libmmg2d_fortran_lsAndMetric_hsiz )
        ...
        ADD_TEST(NAME libmmg2d_fortran_lsAndMetric_optim   COMMAND ${LIBMMG2D_EXECFORTRAN_LSONLY_OPTIM}
          "${PROJECT_SOURCE_DIR}/libexamples/mmg2d/IsosurfDiscretization_lsOnly/multi-mat.mesh"
          "${PROJECT_SOURCE_DIR}/libexamples/mmg2d/IsosurfDiscretization_lsOnly/multi-mat-sol.sol"
          "${CTEST_OUTPUT_DIR}/libmmg2d_lsAndMetric_optim_multimat.o"
          )
        ADD_TEST(NAME libmmg2d_fortran_lsAndMetric_hsiz   COMMAND ${LIBMMG2D_EXECFORTRAN_LSONLY_HSIZ}
          "${PROJECT_SOURCE_DIR}/libexamples/mmg2d/IsosurfDiscretization_lsOnly/multi-mat.mesh"
          "${PROJECT_SOURCE_DIR}/libexamples/mmg2d/IsosurfDiscretization_lsOnly/multi-mat-sol.sol"
          "${CTEST_OUTPUT_DIR}/libmmg2d_lsAndMetric_hsiz_multimat.o"
          )
