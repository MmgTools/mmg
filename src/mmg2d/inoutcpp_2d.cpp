...
static int MMG2D_loadVtkMesh_part2 ( MMG5_pMesh mesh,MMG5_pSol *sol,MMG5_pSol *met,
...
int MMG2D_loadVtpMesh(MMG5_pMesh mesh,MMG5_pSol sol,MMG5_pSol met,const char *filename) {
#ifndef USE_VTK
  ...
  ier = MMG2D_loadVtkMesh_part2(mesh,&sol,&met,&dataset,ptMeditRef,eltMeditRef,nsols,metricData,lsData);
  if ( ier < 1 ) {
    fprintf(stderr,"  ** ERROR WHEN PARSING THE INPUT FILE\n");
    return  ier;
  }
...
int MMG2D_loadVtpMesh_and_allData(MMG5_pMesh mesh,MMG5_pSol *sol,MMG5_pSol *met,const char *filename) {
#ifndef USE_VTK
...
int MMG2D_loadVtkMesh(MMG5_pMesh mesh,MMG5_pSol sol,MMG5_pSol met,const char *filename) {
#ifndef USE_VTK
...
int MMG2D_loadVtkMesh_and_allData(MMG5_pMesh mesh,MMG5_pSol *sol,MMG5_pSol *met,const char *filename) {
#ifndef USE_VTK
...
int MMG2D_loadVtuMesh(MMG5_pMesh mesh,MMG5_pSol sol,MMG5_pSol met,const char *filename) {
#ifndef USE_VTK
...
int MMG2D_loadVtuMesh_and_allData(MMG5_pMesh mesh,MMG5_pSol *sol,MMG5_pSol *met,const char *filename) {
