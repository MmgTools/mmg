...
FORTRAN_NAME(MMG2D_LOADVTKMESH,mmg2d_loadvtkmesh,
             (MMG5_pMesh *mesh, MMG5_pSol *sol, MMG5_pSol *met, char* filename, int *strlen0,int* retval),
             (mesh,sol,met,filename,strlen0, retval)){
  char *tmp = NULL;
  ...
  *retval = MMG2D_loadVtkMesh(*mesh,*sol,*met,tmp);
...
FORTRAN_NAME(MMG2D_LOADVTKMESH_AND_ALLDATA,mmg2d_loadvtkmesh_and_alldata,
  ...
  *retval = MMG2D_loadVtkMesh_and_allData(*mesh,sol,met,tmp);
...
FORTRAN_NAME(MMG2D_LOADVTPMESH,mmg2d_loadvtpmesh,
  ...
  *retval = MMG2D_loadVtpMesh(*mesh,*sol,*met,tmp);
...
FORTRAN_NAME(MMG2D_LOADVTPMESH_AND_ALLDATA,mmg2d_loadvtpmesh_and_alldata,
  ...
  *retval = MMG2D_loadVtpMesh_and_allData(*mesh,sol,met,tmp);
...
FORTRAN_NAME(MMG2D_LOADVTUMESH,mmg2d_loadvtumesh,
  ...
  *retval = MMG2D_loadVtuMesh(*mesh,*sol,*met,tmp);
...
FORTRAN_NAME(MMG2D_LOADVTUMESH_AND_ALLDATA,mmg2d_loadvtumesh_and_alldata,
  ...
  *retval = MMG2D_loadVtuMesh_and_allData(*mesh,sol,met,tmp);
...
FORTRAN_NAME(MMG2D_LOADGENERICMESH,mmg2d_loadgenericmesh,
  ...
  *retval = MMG2D_loadGenericMesh(*mesh,*sol,*met,tmp);
