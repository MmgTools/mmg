...
int MMG2D_mmg2d9(MMG5_pMesh ,MMG5_pSol ,MMG5_pSol,MMG_int** );
//int MMG2D_cendel(MMG5_pMesh ,MMG5_pSol ,double ,int );
int MMG2D_swapdelone(MMG5_pMesh ,MMG5_pSol ,MMG_int ,int8_t ,double ,MMG_int *);
int MMG5_mmg2dChkmsh(MMG5_pMesh , int, int );
int MMG2D_2dMeshCheck(MMG5_pMesh mesh);
int MMG2D_boulep(MMG5_pMesh , MMG_int , int , MMG_int * );
...
int MMG2D_cutEdgeTriangle(MMG5_pMesh ,MMG_int ,MMG_int ,MMG_int );
int MMG2D_findTria(MMG5_pMesh ,MMG_int );
//int MMG2D_findpos(MMG5_pMesh ,MMG5_pTria ,int ,int ,int ,int ,int );
int MMG2D_locateEdge(MMG5_pMesh ,MMG_int ,MMG_int ,MMG_int* ,MMG_int* ) ;
int MMG2D_bdryenforcement(MMG5_pMesh ,MMG5_pSol);
int MMG2D_settagtriangles(MMG5_pMesh ,MMG5_pSol );
int MMG2D_findtrianglestate(MMG5_pMesh ,MMG_int ,MMG_int ,MMG_int ,MMG_int ,MMG_int ,int );
...
int MMG2D_cavity(MMG5_pMesh ,MMG5_pSol ,MMG_int ,MMG_int *);
int MMG2D_delone(MMG5_pMesh ,MMG5_pSol ,MMG_int ,MMG_int *,int );
int MMG2D_cenrad_iso(MMG5_pMesh ,double *,double *,double *);

/* Adds Charles */
double MMG2D_voltri(MMG5_pMesh ,MMG_int ,MMG_int ,MMG_int );
double MMG2D_vfrac(MMG5_pMesh ,MMG5_pSol ,MMG_int ,int );
int MMG2D_parsop(MMG5_pMesh ,MMG5_pSol );
int MMG2D_ismaniball(MMG5_pMesh , MMG5_pSol , MMG_int , int8_t );
...
int MMG2D_split1_sim(MMG5_pMesh ,MMG5_pSol ,MMG_int ,MMG_int vx[3]);
int MMG2D_split2_sim(MMG5_pMesh ,MMG5_pSol ,MMG_int ,MMG_int vx[3]);
int MMG2D_split3_sim(MMG5_pMesh ,MMG5_pSol ,MMG_int ,MMG_int vx[3]);
int MMG2D_split1(MMG5_pMesh ,MMG5_pSol ,MMG_int ,MMG_int vx[3]);
int MMG2D_split2(MMG5_pMesh ,MMG5_pSol ,MMG_int ,MMG_int vx[3]);
int MMG2D_split3(MMG5_pMesh ,MMG5_pSol ,MMG_int ,MMG_int vx[3]);
int MMG2D_splitbar(MMG5_pMesh ,MMG_int ,MMG_int );
...
int MMG2D_boulen(MMG5_pMesh , MMG_int ,int8_t ,MMG_int *,MMG_int *,double *);
...
int MMG2D_defmetbdy_2d(MMG5_pMesh ,MMG5_pSol ,MMG_int ,int8_t );
int MMG2D_defaultmet_2d(MMG5_pMesh ,MMG5_pSol ,MMG_int ,int8_t );
int MMG2D_grad2met_ani(MMG5_pMesh ,MMG5_pSol ,MMG5_pTria,MMG_int,MMG_int);
int MMG2D_grad2metreq_ani(MMG5_pMesh ,MMG5_pSol ,MMG5_pTria,MMG_int,MMG_int);
int MMG2D_gradsiz_ani(MMG5_pMesh ,MMG5_pSol );
int MMG2D_gradsizreq_ani(MMG5_pMesh ,MMG5_pSol );
MMG_int MMG2D_anaelt(MMG5_pMesh ,MMG5_pSol ,int );
MMG_int MMG2D_colelt(MMG5_pMesh ,MMG5_pSol ,int );
MMG_int MMG2D_swpmsh(MMG5_pMesh ,MMG5_pSol ,int );
...
int MMG2D_chkedg(MMG5_pMesh ,MMG_int );
int MMG2D_bezierCurv(MMG5_pMesh ,MMG_int ,int8_t ,double ,double *,double *);
int MMG2D_dichoto(MMG5_pMesh ,MMG5_pSol ,MMG_int ,MMG_int *);
double MMG2D_quickcal(MMG5_pMesh , MMG5_pTria );
int MMG2D_chkcol(MMG5_pMesh,MMG5_pSol,MMG_int,int8_t,MMG_int *,int8_t);
int MMG2D_colver(MMG5_pMesh,int,MMG_int*);
int MMG2D_colver3(MMG5_pMesh,MMG_int*);
int MMG2D_colver2(MMG5_pMesh,MMG_int*);
int MMG2D_boulet(MMG5_pMesh,MMG_int,int8_t,MMG_int*);
int MMG2D_bouleendp(MMG5_pMesh,MMG_int,int8_t,MMG_int*,MMG_int*);
int MMG2D_savemesh_db(MMG5_pMesh ,char* ,int8_t );
int MMG2D_savemet_db(MMG5_pMesh ,MMG5_pSol ,char* ,int8_t );
int MMG2D_chkswp(MMG5_pMesh , MMG5_pSol ,MMG_int ,int8_t ,int8_t );
int MMG2D_swapar(MMG5_pMesh ,MMG_int ,int8_t );
int MMG5_interpmet22(MMG5_pMesh ,double *,double *,double ,double *);
int MMG2D_intmet_iso(MMG5_pMesh ,MMG5_pSol ,MMG_int ,int8_t ,MMG_int ,double );
int MMG2D_intmet_ani(MMG5_pMesh ,MMG5_pSol ,MMG_int ,int8_t ,MMG_int ,double );
...
int MMG2D_movintpt_ani(MMG5_pMesh ,MMG5_pSol ,int ,MMG_int *,int8_t );
