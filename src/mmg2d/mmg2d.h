...
int MMG2D_boulep(MMG5_pMesh , int , int , MMG_int * );
...
int MMG2D_delone(MMG5_pMesh ,MMG5_pSol ,MMG_int ,MMG_int *,MMG_int );
...
int MMG2D_colver(MMG5_pMesh,MMG_int,MMG_int*);
...
int MMG2D_movedgpt(MMG5_pMesh ,MMG5_pSol ,MMG_int ,MMG_int *,int8_t );
int MMG2D_movintpt(MMG5_pMesh ,MMG5_pSol ,MMG_int ,MMG_int *,int8_t );
