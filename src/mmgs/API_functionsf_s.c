...
FORTRAN_NAME(MMGS_SET_MESHSIZE,mmgs_set_meshsize,
             (MMG5_pMesh *mesh, MMG_int *np, MMG_int *nt, MMG_int *na, int *retval),
 ...
 */
FORTRAN_NAME(MMGS_GET_EDGE,mmgs_get_edge,(MMG5_pMesh *mesh, MMG_int* e0, MMG_int* e1, int* ref
 ...
 */
FORTRAN_NAME(MMGS_GET_EDGES,mmgs_get_edges,(MMG5_pMesh *mesh, MMG_int* edges,
 ...
 */
FORTRAN_NAME(MMGS_SET_CORNER,mmgs_set_corner,(MMG5_pMesh *mesh, MMG_int *k, int* retval),
             (mesh,k,retval)) {
 ...
 */
FORTRAN_NAME(MMGS_UNSET_CORNER,mmgs_unset_corner,(MMG5_pMesh *mesh, MMG_int *k, int* retval),
             (mesh,k,retval)) {
...
FORTRAN_NAME(MMGS_SET_ITHSOL_INSOLSATVERTICES,mmgs_set_ithsol_insolsatvertices,
             (MMG5_pSol *sol, MMG_int *i,double *s,int *pos, int* retval),
             (sol,i,s,pos,retval)) {
