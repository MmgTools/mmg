...
int movridpt_ani(pMesh mesh,pSol met,int *list,int ilist) {
    ...
    l1old = lenedg(mesh,met,ip0,ip1,1);
    l2old = lenedg(mesh,met,ip0,ip2,1);
    ll1old = l1old*l1old;
    ll2old = l2old*l2old;
    ...
    l1new = lenedg(mesh,met,0,ip1,1);
    l2new = lenedg(mesh,met,0,ip2,1);
