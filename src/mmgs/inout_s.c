...
int MMGS_loadGenericMesh(MMG5_pMesh mesh, MMG5_pSol sol,MMG5_pSol met, const char *filename) {
  int ier=0;
  ...
  case ( MMG5_FMT_VtkVtp ):
    ier = MMGS_loadVtpMesh(mesh,sol,met,tmp);
    break;

  case ( MMG5_FMT_VtkVtu ):
    ier = MMGS_loadVtuMesh(mesh,sol,met,tmp);
    break;

  case ( MMG5_FMT_VtkVtk ):
    ier = MMGS_loadVtkMesh(mesh,sol,met,tmp);
    break;
