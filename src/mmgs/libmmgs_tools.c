...
/* Define the MMG5_doSol_tetra function from template */
#define MMG5_ELEMENT_TYPE MMG5_Tria
...
int MMGS_doSol_iso(MMG5_pMesh mesh,MMG5_pSol met) {
  ...
  /* Call MMG5_doSol_iso on triangles */
  ier = MMG5_doSol_iso_MMG5_Tria(mesh,met,MMGS_Set_solSize,
                                  mesh->nt,mesh->tria,3,MMGS_iare);
...
int MMGS_doSol_ani(MMG5_pMesh mesh,MMG5_pSol met) {
  ...
  /* Call MMG5_doSol_iso on triangles */
  ier = MMG5_doSol_ani_MMG5_Tria(mesh,met,MMGS_Set_solSize,
                                 mesh->nt,mesh->tria,3,MMGS_iare);
