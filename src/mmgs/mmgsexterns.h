...
FUNCTION_POINTER ( int    (*intmet)(MMG5_pMesh mesh,MMG5_pSol met,int k,int8_t i,int ip,double s) );
FUNCTION_POINTER ( int    (*movintpt)(MMG5_pMesh mesh,MMG5_pSol met,int *list,int ilist) );
FUNCTION_POINTER ( int    (*movridpt)(MMG5_pMesh mesh,MMG5_pSol met,int *list,int ilist) );
