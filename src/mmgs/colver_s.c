...
int colver3(MMG5_pMesh mesh,MMG_int* list) {
  MMG5_pTria   pt,pt1,pt2;
  MMG_int          *adja,iel,jel,kel,mel,ip;
...
int colver2(MMG5_pMesh mesh,MMG_int* list) {
  MMG5_pTria   pt,pt1;
  MMG_int          *adja,iel,jel,kel,ip;
...
/* collapse edge i of k, i1->i2 */
int litcol(MMG5_pMesh mesh,MMG_int k,int8_t i,double kali) {
