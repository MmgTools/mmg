...
int MMG3D_loadGenericMesh(MMG5_pMesh mesh, MMG5_pSol sol,MMG5_pSol met, const char *filename) {
  int ier=0;
  ...
  case ( MMG5_FMT_VtkVtu ):
    ier = MMG3D_loadVtuMesh(mesh,sol,met,tmp);
    break;

  case ( MMG5_FMT_VtkVtk ):
    ier = MMG3D_loadVtkMesh(mesh,sol,met,tmp);
    break;
