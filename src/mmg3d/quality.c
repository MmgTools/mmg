...
/*         if ( nconf ) { */
/*           ns++; */
/*           // Warning: last arg of swpgen stands for the type of metric storage */
/*           // at ridges (must be 1 if call before the defsiz function, 2 otherwise). */
/*           if(!_MMG5_swpgen(mesh,met,nconf,ilist,list,NULL,2)) return(-1); */
/*           break; */
/*         } */
/*       } */
/*     } */
