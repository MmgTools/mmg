...
int MMG3D_cavity_delaunay(MMG5_pMesh mesh ,int iel,int ip,int *list);
...
int    MMG5_gradsiz_ani(MMG5_pMesh ,MMG5_pSol );
...
int    (*MMG5_defsiz)(MMG5_pMesh ,MMG5_pSol );
int    (*MMG5_gradsiz)(MMG5_pMesh ,MMG5_pSol );
