...
int MMG3D_addPROctree(MMG5_pMesh mesh, MMG3D_PROctree* q, const MMG_int no);
int MMG3D_delPROctreeVertex(MMG5_pMesh,MMG3D_PROctree_s* q, int no);
int MMG3D_movePROctree(MMG5_pMesh, MMG3D_pPROctree,MMG_int, double*, double*);
...
int  MMG3D_PROctreein_iso(MMG5_pMesh,MMG5_pSol,MMG3D_pPROctree,MMG_int,double);
int  MMG3D_PROctreein_ani(MMG5_pMesh,MMG5_pSol,MMG3D_pPROctree,MMG_int,double);
...
extern int MMG5_directsurfball(MMG5_pMesh mesh, MMG_int ip, MMG_int *list, int ilist, double n[3]);
...
extern int  MMG5_BezierReg(MMG5_pMesh mesh,MMG_int ip0, MMG_int ip1, double s, double v[3], double *o, double *no);
extern int  MMG5_BezierRef(MMG5_pMesh mesh,MMG_int ip0, MMG_int ip1, double s, double *o, double *no, double *to);
extern int  MMG5_BezierEdge(MMG5_pMesh mesh,MMG_int ip0, MMG_int ip1, double b0[3], double b1[3],int8_t isrid, double v[3]);
extern int  MMG5_BezierRidge(MMG5_pMesh mesh,MMG_int ip0, MMG_int ip1, double s, double *o, double *no1, double *no2, double *to);
extern int  MMG5_BezierNom(MMG5_pMesh mesh,MMG_int ip0,MMG_int ip1,double s,double *o,double *no,double *to);
int  MMG5_norface(MMG5_pMesh mesh ,MMG_int k, int iface, double v[3]);
...
int  MMG5_boulenm(MMG5_pMesh mesh, MMG_int start, int ip, int iface, double n[3],double t[3]);
int  MMG5_boulenmInt(MMG5_pMesh mesh, MMG_int start, int ip, double t[3]);
int  MMG5_boulevolp(MMG5_pMesh mesh, MMG_int start, int ip, MMG_int * list);
int  MMG5_boulesurfvolpNom(MMG5_pMesh mesh,MMG_int start,int ip,int iface,MMG_int *listv,
                          int *ilistv,MMG_int *lists,int*ilists,int*refmin,int*refplus,int isnm);
int  MMG5_boulesurfvolp(MMG5_pMesh mesh,MMG_int start,int ip,int iface,MMG_int *listv,
                         int *ilistv,MMG_int *lists,int*ilists, int isnm);
int  MMG5_bouletrid(MMG5_pMesh,MMG_int,int,int,int *,MMG_int *,int *,MMG_int *,MMG_int *,MMG_int *);
int  MMG5_startedgsurfball(MMG5_pMesh mesh,MMG_int nump,MMG_int numq,MMG_int *list,int ilist);
int  MMG5_srcbdy(MMG5_pMesh mesh,MMG_int start,int ia);
int  MMG5_coquil(MMG5_pMesh mesh, MMG_int start, int ia, MMG_int * list);
int  MMG5_coquilface(MMG5_pMesh mesh, MMG_int start,int8_t iface,int,MMG_int*,MMG_int*,MMG_int*,int);
int MMG3D_coquilFaceFirstLoop(MMG5_pMesh mesh,MMG_int start,MMG_int na,MMG_int nb,int8_t iface,
                               int8_t ia,MMG_int *list,int *ilist,MMG_int *it1,MMG_int *it2,
                               MMG_int *piv,MMG_int *adj,int8_t *hasadja,int *nbdy,int silent);
void MMG3D_coquilFaceSecondLoopInit(MMG5_pMesh mesh,MMG_int piv,int8_t *iface,int8_t *i,
                                     MMG_int *list,int *ilist,MMG_int *it1,MMG_int *pradj,
                                     MMG_int *adj);
void MMG5_coquilFaceErrorMessage(MMG5_pMesh mesh, MMG_int k1, MMG_int k2);
int16_t MMG5_coquilTravel(MMG5_pMesh,MMG_int,MMG_int,MMG_int*,MMG_int*,int8_t*,int8_t*);
int16_t MMG5_openCoquilTravel(MMG5_pMesh,MMG_int,MMG_int,MMG_int*,MMG_int*,int8_t*,int8_t*);
int  MMG5_settag(MMG5_pMesh,MMG_int,int,int16_t,int);
int  MMG5_deltag(MMG5_pMesh,MMG_int,int,int16_t);
int  MMG5_setNmTag(MMG5_pMesh mesh, MMG5_Hash *hash);
int  MMG5_chkcol_int(MMG5_pMesh,MMG5_pSol,MMG_int,int8_t,int8_t,MMG_int*,int,int8_t);
int  MMG5_chkcol_bdy(MMG5_pMesh,MMG5_pSol,MMG_int,int8_t,int8_t,MMG_int*,int,MMG_int*,int,int,int,int8_t,int);
int  MMG5_chkcol_nomint(MMG5_pMesh,MMG5_pSol,MMG_int,int8_t,int8_t,MMG_int*,int,int8_t);
int  MMG5_chkmanicoll(MMG5_pMesh,MMG_int,int,int,MMG_int,MMG_int,int,int,int8_t,int8_t);
int  MMG5_chkmani(MMG5_pMesh mesh);
int  MMG5_colver(MMG5_pMesh,MMG5_pSol,MMG_int *,int,int8_t,int8_t);
...
int  MMG5_hashFace(MMG5_pMesh,MMG5_Hash*,MMG_int,MMG_int,MMG_int,MMG_int);
int  MMG5_hashGetFace(MMG5_Hash*,MMG_int,MMG_int,MMG_int);
...
int  MMG5_cntbdypt(MMG5_pMesh mesh, MMG_int nump);
...
int  MMG5_mmg3d1_pattern(MMG5_pMesh ,MMG5_pSol,MMG_int* );
int  MMG5_mmg3d1_delone(MMG5_pMesh ,MMG5_pSol,MMG_int* );
...
int  MMG3D_setMeshSize_initData(MMG5_pMesh,MMG_int,MMG_int,int,MMG_int,int,MMG_int);
...
int  MMG5_split1b(MMG5_pMesh,MMG5_pSol,MMG_int*,int,MMG_int,int,int8_t,int8_t);
...
int  MMG5_split2sf(MMG5_pMesh mesh,MMG5_pSol met,MMG_int k,MMG_int vx[6],int8_t);
int  MMG3D_split2_sim(MMG5_pMesh mesh,MMG5_pSol met,MMG_int k,MMG_int vx[6]);
int  MMG5_split2(MMG5_pMesh mesh,MMG5_pSol met,MMG_int k,MMG_int vx[6],int8_t);
int  MMG3D_split3_sim(MMG5_pMesh mesh,MMG5_pSol met,MMG_int k,MMG_int vx[6]);
int  MMG5_split3(MMG5_pMesh mesh,MMG5_pSol met,MMG_int k,MMG_int vx[6],int8_t);
int  MMG3D_split3cone_sim(MMG5_pMesh mesh,MMG5_pSol met,MMG_int k,MMG_int vx[6]);
int  MMG5_split3cone(MMG5_pMesh mesh,MMG5_pSol met,MMG_int k,MMG_int vx[6],int8_t);
int  MMG3D_split3op_sim(MMG5_pMesh mesh,MMG5_pSol met,MMG_int k,MMG_int vx[6]);
int  MMG5_split3op(MMG5_pMesh mesh, MMG5_pSol met, MMG_int k, MMG_int vx[6],int8_t);
int  MMG3D_split4sf_sim(MMG5_pMesh mesh,MMG5_pSol met,MMG_int k,MMG_int vx[6]);
int  MMG5_split4sf(MMG5_pMesh mesh,MMG5_pSol met,MMG_int k,MMG_int vx[6],int8_t);
int  MMG3D_split4op_sim(MMG5_pMesh mesh,MMG5_pSol met,MMG_int k,MMG_int vx[6]);
int  MMG5_split4op(MMG5_pMesh mesh,MMG5_pSol met,MMG_int k,MMG_int vx[6],int8_t);
int  MMG3D_split5_sim(MMG5_pMesh mesh,MMG5_pSol met,MMG_int k,MMG_int vx[6]);
int  MMG5_split5(MMG5_pMesh mesh,MMG5_pSol met,MMG_int k,MMG_int vx[6],int8_t);
int  MMG3D_split6_sim(MMG5_pMesh mesh,MMG5_pSol met,MMG_int k,MMG_int vx[6]);
int  MMG5_split6(MMG5_pMesh mesh,MMG5_pSol met,MMG_int k,MMG_int vx[6],int8_t);
MMG_int  MMG5_split4bar(MMG5_pMesh mesh,MMG5_pSol met,MMG_int k,int8_t);
int  MMG3D_simbulgept(MMG5_pMesh mesh,MMG5_pSol met, MMG_int *list, int ilist,MMG_int);
void MMG5_nsort(int ,double *,int8_t *);
int    MMG3D_optlap(MMG5_pMesh ,MMG5_pSol );
int    MMG5_movintpt_iso(MMG5_pMesh ,MMG5_pSol,MMG3D_pPROctree, MMG_int *, int , int);
int    MMG3D_movnormal_iso(MMG5_pMesh ,MMG5_pSol ,MMG_int ,int );
int    MMG5_movintptLES_iso(MMG5_pMesh mesh,MMG5_pSol met,MMG3D_pPROctree,MMG_int *,int,int);
int    MMG5_movintpt_ani(MMG5_pMesh ,MMG5_pSol,MMG3D_pPROctree,MMG_int *,int ,int);
int    MMG5_movbdyregpt_iso(MMG5_pMesh, MMG5_pSol,MMG3D_pPROctree,
                             MMG_int*, int, MMG_int*, int, int ,int);
int    MMG5_movbdyregpt_ani(MMG5_pMesh, MMG5_pSol,MMG3D_pPROctree,
                             MMG_int*, int, MMG_int*, int, int ,int);
int    MMG5_movbdyrefpt_iso(MMG5_pMesh, MMG5_pSol,MMG3D_pPROctree, MMG_int*, int,
                             MMG_int*, int ,int);
int    MMG5_movbdyrefpt_ani(MMG5_pMesh, MMG5_pSol,MMG3D_pPROctree, MMG_int*, int,
                             MMG_int*, int ,int);
int    MMG5_movbdynompt_iso(MMG5_pMesh, MMG5_pSol,MMG3D_pPROctree, MMG_int*, int,
                             MMG_int*, int ,int);
int    MMG5_movbdynomintpt_iso(MMG5_pMesh, MMG5_pSol,MMG3D_pPROctree, MMG_int*, int, int);
int    MMG5_movbdynompt_ani(MMG5_pMesh, MMG5_pSol,MMG3D_pPROctree, MMG_int*, int,
                             MMG_int*, int ,int);
int    MMG5_movbdyridpt_iso(MMG5_pMesh, MMG5_pSol,MMG3D_pPROctree, MMG_int*, int,
                             MMG_int*, int ,int);
int    MMG5_movbdyridpt_ani(MMG5_pMesh, MMG5_pSol,MMG3D_pPROctree, MMG_int*, int,
                             MMG_int*, int ,int);
int    MMG3D_movv_ani(MMG5_pMesh ,MMG5_pSol ,MMG_int ,int );
int    MMG3D_movv_iso(MMG5_pMesh ,MMG5_pSol ,MMG_int ,int );
...
int MMG3D_displayQualHisto(MMG_int,double,double,double,MMG_int,MMG_int,MMG_int,
                           int his[5],MMG_int,int,int);
int MMG3D_displayQualHisto_internal(MMG_int,double,double,double,MMG_int,MMG_int,MMG_int,
                                    int his[5],MMG_int,int,int);
void MMG3D_computeInqua(MMG5_pMesh,MMG5_pSol,MMG_int*,double*,double*,double*,MMG_int*,MMG_int*,
                        MMG_int*,int his[5],int);
int  MMG3D_inqua(MMG5_pMesh mesh,MMG5_pSol met);
void MMG3D_computeOutqua(MMG5_pMesh,MMG5_pSol,MMG_int*,double*,double*,double*,MMG_int*,MMG_int*,
                         MMG_int*,int his[5],MMG_int*,int);
int  MMG3D_outqua(MMG5_pMesh mesh,MMG5_pSol met);
void MMG3D_computeLESqua(MMG5_pMesh,MMG5_pSol,MMG_int*,double*,double*,double*,MMG_int*,MMG_int*,
                         MMG_int*,int his[5],int);
int MMG3D_computePrilen(MMG5_pMesh,MMG5_pSol,double*,double*,double*,int*,MMG_int*,MMG_int*,
...
int MMG3D_localParamNm(MMG5_pMesh,MMG_int,int,int,double*,double*,double*);
...
MMG_int  MMG3D_pack_points(MMG5_pMesh mesh);
...
/* rmc option */
double MMG3D_vfrac(MMG5_pMesh ,MMG5_pSol ,MMG_int ,int );
...
MMG_int  MMG3D_indElt(MMG5_pMesh mesh,MMG_int kel);
MMG_int  MMG3D_indPt(MMG5_pMesh mesh,MMG_int kp);
void MMG5_printTetra(MMG5_pMesh mesh,char* fileName);


#ifdef USE_SCOTCH
int MMG5_mmg3dRenumbering(MMG_int,MMG5_pMesh,MMG5_pSol,MMG5_pSol,MMG_int*);
#endif

int    MMG5_meancur(MMG5_pMesh mesh,MMG_int np,double c[3],int ilist,MMG_int *list,double h[3]);
...
int  MMG5_mmg3d3(MMG5_pMesh ,MMG5_pSol, MMG5_pSol,MMG_int** );
int  MMG5_velextLS(MMG5_pMesh ,MMG5_pSol );
int MMG5_saveDisp(MMG5_pMesh ,MMG5_pSol );

/* Delaunay functions*/
int MMG5_delone(MMG5_pMesh mesh,MMG5_pSol sol,MMG_int ip,MMG_int *list,int ilist);
  int MMG5_cavity_iso(MMG5_pMesh mesh,MMG5_pSol sol,MMG_int iel,int ip,MMG_int *list,int lon,double volmin);
  int MMG5_cavity_ani(MMG5_pMesh mesh,MMG5_pSol sol,MMG_int iel,int ip,MMG_int *list,int lon,double volmin);
...
/* mmg3d1.c */
void MMG5_tet2tri(MMG5_pMesh mesh,MMG_int k,int8_t ie,MMG5_Tria *ptt);
int  MMG3D_dichoto(MMG5_pMesh mesh,MMG5_pSol met,MMG_int k,MMG_int *vx);
int  MMG3D_dichoto1b(MMG5_pMesh mesh,MMG5_pSol met,MMG_int *list,int ret,MMG_int);
int8_t MMG5_chkedg(MMG5_pMesh mesh,MMG5_Tria *pt,int8_t ori,double,double,int);
int  MMG3D_splsurfedge( MMG5_pMesh,MMG5_pSol,MMG_int,MMG5_pTetra,MMG5_pxTetra,int8_t,
                        int8_t,int8_t,int* );
int  MMG5_anatet(MMG5_pMesh mesh,MMG5_pSol met, int8_t typchk, int patternMode) ;
MMG_int  MMG5_movtet(MMG5_pMesh mesh,MMG5_pSol met,MMG3D_pPROctree PROctree,
...
int    MMG5_intmet_iso(MMG5_pMesh,MMG5_pSol,MMG_int,int8_t,MMG_int, double);
int    MMG5_intmet_ani(MMG5_pMesh,MMG5_pSol,MMG_int,int8_t,MMG_int, double);
...
double     MMG5_meansizreg_iso(MMG5_pMesh,MMG5_pSol,MMG_int,MMG_int*,int,double,double);
...
extern int    (*MMG5_intmet)(MMG5_pMesh,MMG5_pSol,MMG_int,int8_t,MMG_int, double);
extern int    (*MMG5_interp4bar)(MMG5_pMesh,MMG5_pSol,MMG_int,MMG_int,double *);
extern int    (*MMG5_movintpt)(MMG5_pMesh ,MMG5_pSol, MMG3D_pPROctree ,MMG_int *, int , int );
extern int    (*MMG5_movbdyregpt)(MMG5_pMesh, MMG5_pSol, MMG3D_pPROctree ,MMG_int*, int, MMG_int*, int, int ,int);
extern int    (*MMG5_movbdyrefpt)(MMG5_pMesh, MMG5_pSol, MMG3D_pPROctree ,MMG_int*, int, MMG_int*, int ,int);
extern int    (*MMG5_movbdynompt)(MMG5_pMesh, MMG5_pSol, MMG3D_pPROctree ,MMG_int*, int, MMG_int*, int ,int);
extern int    (*MMG5_movbdyridpt)(MMG5_pMesh, MMG5_pSol, MMG3D_pPROctree ,MMG_int*, int, MMG_int*, int ,int);
extern int    (*MMG5_cavity)(MMG5_pMesh ,MMG5_pSol ,MMG_int ,int ,MMG_int *,int ,double);
extern int    (*MMG3D_PROctreein)(MMG5_pMesh ,MMG5_pSol ,MMG3D_pPROctree ,MMG_int,double );
