...
int _MMG3D_memOption_memSet(MMG5_pMesh mesh) {
  ...
  if ( mesh->info.mem <= 0 ) {
    ...
    if ( mesh->info.mem*_MMG5_MILLION > mesh->memMax && mesh->memMax ) {
