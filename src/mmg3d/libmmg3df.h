...
!  * \return 1 if success
!  *
!  * Compute isotropic size map according to the mean of the lentructure deallocations before return.
!  *
!  * \remark we pass the structures by reference in order to have argument
!  * compatibility between the library call from a Fortran code and a C code.
!  *
...
! int  MMG5_Set_requiredEdge(MMG5_pMesh mesh, int k)gth of the edges
!  * passing through a point.
!  *
!  */
...
! int MMG5_Get_vectorSol(MMG5_pSol ;
! /**
!  * \param met pointer toward the sol structure.
!  * \param s solution scalar value.
!  * \param pos position of the solution in the mesh.
...
! #endif
met, double* vx, double* vy, double* vz);
! /**
!  * \param met pointer toward the sol structure.
!  * \param m11 pointer toward the position (1,1) in the solution tensor.
!  * \param m12 pointer toward the position (1,2) in the solution tensor.
