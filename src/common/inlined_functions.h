 ...
 */
static inline
double MMG5_lenEdg(MMG5_pMesh mesh,MMG_int np0,MMG_int np1,
 ...
 */
static inline
double MMG5_lenSurfEdg_ani(MMG5_pMesh mesh,MMG5_pSol met,MMG_int np0,MMG_int np1,int8_t isedg) {
  MMG5_pPoint   p0,p1;
...
double MMG5_lenSurfEdg33_ani(MMG5_pMesh mesh,MMG5_pSol met,
                              MMG_int np0,MMG_int np1,int8_t isedg) {
  double        *m0,*m1;
 ...
 */
static
inline double MMG5_lenSurfEdg_iso(MMG5_pMesh mesh,MMG5_pSol met,MMG_int ip1,MMG_int ip2, int8_t isedg) {
  MMG5_pPoint   p1,p2;
