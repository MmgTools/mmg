...
void           MMG5_check_hminhmax(MMG5_pMesh mesh, int8_t sethmin, int8_t sethmax);
 ...
 LIBMMG_CORE_EXPORT int           MMG5_Get_format( char *ptr, int );
 ...
 LIBMMG_CORE_EXPORT extern int    MMG5_countLocalParamAtTri( MMG5_pMesh,MMG5_iNode **);
 LIBMMG_CORE_EXPORT extern int    MMG5_writeLocalParamAtTri( MMG5_pMesh,MMG5_iNode *,FILE*);
