...
int bezierInt(pBezier pb,double uv[2],double o[3],double no[3],double to[3]) {
  ...
  //if(ddb) {printf("Les coefs : %f %f %f \n %f %f %f \n %f %f %f \n", pb->b[0][0], pb->b[0][1],pb->b[0][2], pb->b[1][0], pb->b[1][1],pb->b[1][2], pb->b[2][0], pb->b[2][1],pb->b[2][2]);  
  //printf("Les coefs : %f %f %f \n %f %f %f \n %f %f %f \n", pb->b[3][0], pb->b[3][1],pb->b[3][2], pb->b[4][0], pb->b[4][1],pb->b[4][2], pb->b[5][0], pb->b[5][1],pb->b[5][2]);
  //printf("Les coefs : %f %f %f \n %f %f %f \n %f %f %f \n", pb->b[6][0], pb->b[6][1],pb->b[6][2], pb->b[7][0], pb->b[7][1],pb->b[7][2], pb->b[8][0], pb->b[8][1],pb->b[8][2]);}
  /* coordinates + normals */
  for (i=0; i<3; i++) {
