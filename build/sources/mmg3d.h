...
int  chkcol_int(pMesh,int,char,char,int *);
...
int  swpbdy(pMesh mesh,int *list,int ret,int it1);
void swpgen(pMesh mesh, int nconf, int ilist, int *list);
