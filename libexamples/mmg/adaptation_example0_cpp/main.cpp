...
int main(int argc,char *argv[]) {
  ...
  if ( MMGS_Set_inputMeshName(mmgMesh,filename.c_str()) != 1 )
    exit(EXIT_FAILURE);
  /** b) function calling */
  ...
  if ( MMGS_Set_inputSolName(mmgMesh,mmgSol,filename.c_str()) != 1 )
    exit(EXIT_FAILURE);
  ...
  if ( MMGS_Set_outputMeshName(mmgMesh,filename_os.c_str()) != 1 )
    exit(EXIT_FAILURE);
  /** b) function calling */
  /*save result*/
  ...
  if ( MMGS_Set_outputSolName(mmgMesh,mmgSol,filename_os.c_str()) != 1 )
    exit(EXIT_FAILURE);
  /** b) function calling */
  /*save metric*/
  ...
  /** a) (not mandatory): give the mesh name
      (by default, the "mesh.mesh" file is oppened)*/
  if ( MMG3D_Set_inputMeshName(mmgMesh,filename.c_str()) != 1 )
    exit(EXIT_FAILURE);
  /** b) function calling */
  ...
  if ( MMG3D_Set_inputSolName(mmgMesh,mmgSol,filename.c_str()) != 1 )
    exit(EXIT_FAILURE);
  /** b) function calling */
  ...
  /** a)  (not mandatory): give the ouptut mesh name using MMG3D_Set_outputMeshName
      (by default, the mesh is saved in the "mesh.o.mesh" file */
  if ( MMG3D_Set_outputMeshName(mmgMesh,filename_o3d.c_str()) != 1 )
    exit(EXIT_FAILURE);
  /** b) function calling */
  ...
  /** a)  (not mandatory): give the ouptut sol name using MMG3D_Set_outputSolName
      (by default, the mesh is saved in the "mesh.o.sol" file */
  if ( MMG3D_Set_outputSolName(mmgMesh,mmgSol,filename_o3d.c_str()) != 1 )
    exit(EXIT_FAILURE);
  /** b) function calling */
